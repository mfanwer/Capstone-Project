...
if (!empty($user_id)) {
    ...
    if (isset($_POST['btnsubmit'])) {
        ...
        $sql_query = "INSERT INTO offer_of_day(resturent_id,offer_name,details,price,image,created)VALUES('" . $user_id . "','" . $meal_name . "','" . $meal_deteails . "','" . $price . "','" . $comImagePath . "','" . date('Y-m-d h:i:s') . "')";
        $result = mysql_query($sql_query);
        if ($result) {
            header("location:offer.php?status=success");
        } else {
    ...
    <html>
        <head>
            <title>Add Offer of the Day - Restaurant Management System </title>
        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="title-box clearfix">&nbsp;<br/><br/></div> 
                        <form class="form-light mt-20" role="form" method="post" action="offer.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
