...
<html>
    <head>
        <title>Contact Us - Johnny on the Spot</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="section-title">Your Query/Feedback</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="contact-info">
                                <h5><b>Address</b></h5>
                                <p>3rd Floor, Rana Apartment Mansi Vihar Colony, Sector - 23, Sanjay Nagar, Ghaziabad, Uttar Pradesh 201002</p>

                                <h5><b>Email</b></h5>
                                <p>help@jonnyonthespot.com</p>
